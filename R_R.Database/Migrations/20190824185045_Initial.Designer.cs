...
namespace R_R.Database.Migrations
{
    ...
    [Migration("20190824185045_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("R_R.Common.Entities.Identity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("R_R.Common.Entities.Rift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("R_R.Common.Entities.Identity", b =>
                {
                    b.HasOne("R_R.Common.Entities.Character", "Character")
                        .WithOne("Identity")
                        .HasForeignKey("R_R.Common.Entities.Identity", "CharacterId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("R_R.Common.Entities.LogosTheme", b =>
                {
                    b.HasOne("R_R.Common.Entities.Identity", "Identity")
            ...
            modelBuilder.Entity("R_R.Common.Entities.MythosTheme", b =>
                {
                    b.HasOne("R_R.Common.Entities.Rift", "Rift")
                        .WithMany("MythosThemes")
                        .HasForeignKey("RiftId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("R_R.Common.Entities.Rift", b =>
                {
                    b.HasOne("R_R.Common.Entities.Character", "Character")
                        .WithOne("Rift")
                        .HasForeignKey("R_R.Common.Entities.Rift", "CharacterId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
